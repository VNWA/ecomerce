            ...
            <DialogModal :show="isModalDeleteForm" @close="closeModal">
                <template #title>
                    ...
                    <div class=" text-red-500   text-center">
                        <div>
                            <Icon icon="fa6-solid:triangle-exclamation"   class="text-4xl" />
                        ...
                        <div class="bg-black/80 p-5">
                            <div class=" mb-5 flex items-center justify-between font-bold text-xl bg-white py-2 px-2">
                                ...
                                <button @click="showFormCreate"
                                    class="bg-sky-700 hover:bg-sky-900 py-1 px-5 rounded-sm text-white flex items-center justify-center gap-4 ">
                            ...
                            <Draggable class="mtl-tree capitalize" v-model="treeData" treeLine :defaultOpen="false"
                                ...
                                <template #default="{ node, stat }">
                                    <div class=" mx-3 flex cursor-pointer items-center gap-4 "
                                        ...
                                        <div @click="showFormEdit(node.id)" class="flex items-center justify-center gap-2">
                                            <Icon v-if="node.is_header == 1"  icon="material-symbols:family-star"
                                                class="text-purple-500" /> {{ node.name }} ({{ node.children.length
                                            }})
                                        </div>
                    ...
                    <div class="col-span-8 ">
                        <div class=" bg-white relative">
                            ...
                            <div class="p-4">
                                ...
                                <div class="mb-4">
                                    <InputLabel for="BannerImage" value="Banner Image" />
                                    <InputUrlImage id="BannerImage" class="mt-1 block   " v-model="form.banner_image" />
                                    <InputError class="mt-2" :message="errors.banner_image" />
                                </div>
                                <div class="mb-4">
                                    ...
                                    <div v-if="form.is_header == 1" class="border px-3 py-4">
                                        <div class="flex items-center ps-4 border border-gray-200 rounded mb-3 ">
                                            <input type="color" id="is_header_sub_colors"
                                        ...
                                        <div class="flex items-center ps-4 border border-gray-200 rounded mb-3 ">
                                            <input type="checkbox" id="is_header_sub_colors"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500   focus:ring-2  "
    ...
    axios.get('/vnwa/ecommerce/product-categories/get-detail-category/' + id)
        .then(response => {
            form.value = {
                ...
                is_header: response.data.is_header,
                is_header_sub_colors: response.data.is_header_sub_colors,
                header_bg: response.data.header_bg,
                seo_meta: {
