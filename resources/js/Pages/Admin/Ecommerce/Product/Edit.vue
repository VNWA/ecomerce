        ...
        <AppLayout title=" Edit  Product" :isLoading="isPageLoading">
            <template #header>
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <HeaderBreadcrumbs
                            :breadcrumbs="[['Product', route('Ecommerce.Product')], [' Edit', route('Ecommerce.Product.Edit', product.id)]]" />
                    </div>
                </div>
            </template>
            ...
            <div class="grid grid-cols-12 gap-4 p-2">
                ...
                <div class="lg:col-span-4 col-span-12">
                    <div class="flex flex-col">
                        ...
                        <div class="bg-white shadow rounded-sm mb-4 p-2">
                            <div class="py-2 border-b border-black/10 mb-5">
                                <h2 class="text-md flex items-center gap-2 text-black">Status <span
...
const form = reactive({
    ...
    is_seller: props.product.is_seller,
    ...
    is_discount: props.product.is_discount,
...
const submit = (isRollBack = true) => {
    ...
    axios.post('/vnwa/ecommerce/products/update/' + props.product.id, form).then(response => {
