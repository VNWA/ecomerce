            ...
            <div class="max-w-12xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg pt-8 pb-12 px-2">
                    ...
                    <div class="float-right text-xs uppercase">
                        ...
                        <Link :href="route('Ecommerce.Color.Create')"
...
export default {
    ...
    methods: {
        ...
        async deleteItems() {
            ...
            try {
                ...
                const response = await axios.post('/vnwa/ecommerce/colors/delete', { dataId: dataDelete });
    ...
    setup() {
        ...
        const loadData = () => {
            axios.post('/vnwa/ecommerce/colors/load-data-table')
                .then((response) => {
