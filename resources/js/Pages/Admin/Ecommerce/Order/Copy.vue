<template>
    <div>
        <AppLayout title="Coppy Order" :isLoading="isPageLoading">
            <template #header>
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Coppy Order</h2>
                    </div>
                    <div>
                        <HeaderBreadcrumbs
                        ...
                        <div class="bg-white shadow rounded-sm mb-3 p-2  text-black/80">
                            ...
                            <div>
                                <div v-for="(item, index) in deliveries" :key="index">
                                    <div v-if="item.value == deliveryCountry || !deliveryCountry">
                                        <label v-for="(value, n) in item.deliveries" :key="n"
                                            :for="'delivery' + index + n" class="mb-3">
