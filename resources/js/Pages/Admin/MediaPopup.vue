<template>
    <div class=" mediaPopup bg-white text-black/80 border border-solid border-purple-500 border-t-0">
        <div class="min-h-screen py-2 relative">
            ...
            <div class="w-full p-3 rounded relative">
                <div class="border border-black/20 py-3 bg-white sticky top-0 left-0">
                    <div class="flex items-center justify-between">
                        <div class="flex px-3 gap-4">
                            ...
                            <button
                                ...
                                <Icon icon="fa6-solid:folder-plus" />
                            </button>
                            <button
                                class="flex items-center justify-center gap-2 bg-purple-500 px-3 py-2 text-white rounded font-bold"
                                @click="loadData">
                ...
                <div class="flex h-full">
                    <div class="w-full max-h-60vh h-auto overflow-y-scroll overflow-x-visible" id="media_files"
                        @mouseenter="isMouseInside = true" @mouseleave="isMouseInside = false">
                                        ...
                                        <ul
                                            ...
                                            <li v-else>
                                                <a @click="isMouseRightItemKey = null" target="_blank" :href="item.path"
                                                    class="px-3 py-1 hover:bg-black/50 hover:text-white/60 border border-black/50 w-full flex items-center gap-4">
                                                    <Icon icon="fa6-solid:eye" /> Preview
                                                </a>
                                            </li>
                                            <li>
                                                <button
                                                    ...
                                                    <Icon icon="fa6-solid:pen-to-square" /> Rename
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="w-3/12 media_detail h-full" v-if="adminStore.isMediaDetailShow">
...
const insertData = () => {
    if (keySelected.value.length === 0) {
        toast.error("Chọn ít nhất một file", { autoClose: 1500 });
        return;
    }
    ...
    if (data.length === 0) {
        toast.error("Chọn ít nhất một file hợp lệ", { autoClose: 1500 });
        return;
    }
