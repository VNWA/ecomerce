    ...
    <div>
        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
            ...
            <h1 class="mt-8 text-2xl font-medium text-gray-900">
                Welcome to  Vinawebapp Admin Dashboard!
            </h1>

            <p class="mt-6 text-gray-500 leading-relaxed">
                Vinawebapp.com tự hào là nền tảng phát triển web tối ưu, cung cấp giải pháp quản trị mạnh mẽ và linh
                hoạt cho doanh nghiệp của bạn.
                Với sự hỗ trợ của Vinawebapp Admin Dashboard, bạn sẽ trải nghiệm một môi trường làm việc hiện đại, dễ dàng và
                hiệu quả,
                giúp hiện thực hóa mọi ý tưởng sáng tạo trong lập trình. Cùng xây dựng tương lai số với Vinawebapp!
            </p>
        </div>
